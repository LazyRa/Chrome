...
// @version           3.5.2
// @description       【❤️ 视频自动解析，体会拥有VIP的感觉❤️，适配PC+移动 】功能有：1、解锁B站大会员番剧、B站视频解析下载(支持多P下载)；2、爱奇艺、腾讯、优酷、芒果等全网VIP视频免费破解去广告(免跳出观影特方便)；3、网易云音乐、QQ音乐、酷狗、荔枝FM、喜马拉雅等音乐和有声书音频免客户端下载；4、油管、Facebook等国外视频解析下载；5、网盘搜索引擎(来搜一下:laisoyixia.com, 小猪快盘:xiaozhukuaipan.com)破解无限下载；6、优惠券查询等；7、搜索引擎导航【脚本长期维护更新，完全免费，无广告】
// @author            爱画画的猫,小艾特
...
(function () {
	...
	const customizeInterfaceList=[
		//{ name:"就是名字而已",url:"https://jx.idc126.net/jx/?url=", "showType":3},
		//{ name:"就是名字而已", url:"https://jx.idc126.net/jx/?url=", "showType":3},
	];
										...
										<div class='vip_mod_box_action_687ii default-scrollbar-55678'>
											<div class='item_box`+this.elementId+`'>
												...
												<div class='content`+this.elementId+`'>
													脚本默认新标签页解析，如需要在本网页解析播放，请手动打开站内解析功能（选中左侧单选框开启）！！！
												</div>
											</div>
											<div class='item_box`+this.elementId+`'>
